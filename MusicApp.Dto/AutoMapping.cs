...
namespace MusicApp.Dto
{
    public class AutoMapping : Profile
    {
        public AutoMapping()
        {
            ...
            CreateMap<AlbumDto, Albums>().ForMember(dest => dest.Artist, act => act.MapFrom(src => src.Artist)).ForMember(dest => dest.AlbumsFiles, opt => opt.MapFrom(src => src.Images)).ReverseMap();
